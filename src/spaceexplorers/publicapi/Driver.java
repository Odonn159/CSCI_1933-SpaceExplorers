...
public class Driver {
    public static void main(String[] args) {
        try {
            ...
            // Choose player1 strategies in game window, one in initializer
            //GameWindow window = new GameWindow(StudentStrategy.class, true);
            //Choose both in initializer
            //GameWindow window = new GameWindow(StudentStrategy.class, NoOpStrategy.class);
